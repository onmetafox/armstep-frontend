        ...
        <div className='container'>
            <div className='d-flex'>
                <div className='project-detail'>
                    ...
                    <div className='fs-s1 color-white m-4 lh-base text-start'>As a seasoned creator of contemporary, user-<br></br>friendly web designs and digital solutions, I aim <br></br>to assist you in constructing the brand of your fantasies.</div>
                </div>
