import gravitonThumb from "../assets/images/projects/thumb-graviton.png";
import gravitonImg from "../assets/images/projects/graviton.png";
import demoverseThumb from "../assets/images/projects/thumb-demoverse.png";
import demoverseImg from "../assets/images/projects/demoverse.png";
import slashThumb from "../assets/images/projects/thumb-slash.png";
import slashImg from "../assets/images/projects/slash.png";
import tribeThumb from "../assets/images/projects/thumb-tribeone.png";
import tribeImg from "../assets/images/projects/tribeone.png";
import serenityThumb from "../assets/images/projects/thumb-serenity.png";
import serenityImg from "../assets/images/projects/serenity.png";
import superThumb from "../assets/images/projects/thumb-superlocal.png";
import superImg from "../assets/images/projects/superlocal.png";
...
export const projectData = [
    {
        ...
        overview: "Graviton aims to develop three Web3 products: NFT-Display, NFT-Storage, and NFT-Torrents, catering to artists in the NFT space. \nThese products, available as both web and desktop versions, will enable artists to showcase, securely store, and distribute their NFT artworks. \nThe project involves translating existing Figma designs into functional interfaces, integrating blockchain technology, ensuring user security, implementing monetization strategies, and fostering a community of artists and fans. The goal is to create a seamless, secure, and user-friendly ecosystem for artists to reach their audience and monetize their talents in the Web3 world.",
    ...
    },
    {
        ...
        link: "https://github.com",
        team: ["AI and Full Stack developer"],
        duration: "18 months",
        stacks: ["Tensorflow", "Pytorch", "BigQuery", "Google Cloud", "React", "Django"],
    ...
    },
    {
        ...
        link: "https://github.com",
        team: ["1 Full Stack", "Blockchain developer"],
        duration: "9 months",
        stacks: ["Create Web3 tools for artists", "NFT-Display", "NFT-Storage", "NFT-Torrents", "web & desktop"],
    ...
    },
    {
        ...
        link: "https://github.com",
        team: ["2 Full Stack", "1 Blockchain developer"],
        duration: "4 months",
        stacks: ["Solidity", "Rust", "React", "Node", "Hardhat", "and other related technologies"],
    ...
    },
    {
        ...
        link: "https://github.com",
        team: ["1 Blockchain", "Mobile developer", "1 Crypto Economist"],
        duration: "6 months",
        stacks: ["Angular.js", "Node.js", "Solidity", "Alchemy", "Hardhat", "etc."],
